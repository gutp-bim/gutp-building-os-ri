...
**ValidMessageJson のフィールド契約は [telemetry-specification.md](telemetry-specification.md) を参照してください。**
...
設計詳細は [oss-hono-design.md](oss-hono-design.md) を参照してください。
...
詳細は [telemetry-specification.md](telemetry-specification.md) を参照してください。

---

## 関連ドキュメント

- [telemetry-specification.md](telemetry-specification.md) — `ValidMessageJson` フィールド契約
- [oss-nats-design.md](oss-nats-design.md) — NATS サブジェクト・ストリーム設計
- [gateway-integration.md](gateway-integration.md) — gRPC GatewayIngress（推奨取り込み経路）
- [oss-hono-design.md](oss-hono-design.md) — MQTT / AMQP Northbound 接続設計
- [adr/0001-at-most-once-connector-delivery.md](adr/0001-at-most-once-connector-delivery.md) — 配信保証の設計判断
