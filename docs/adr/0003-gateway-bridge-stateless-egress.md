...
1. **ルーティング = per-gateway NATS subject**。ストリームを収容したレプリカが
   ...
   `docs/operations/oss-gateway-bridge-infra.md`。
...
- 関連: `docs/project/oss-egress-gateway-bridge-plan.md`, `docs/architecture/gateway-bridge-ingress-egress-split.md`,
  `docs/operations/oss-gateway-bridge-infra.md`, `DotNet/BuildingOS.GatewayBridge/README.md`。
