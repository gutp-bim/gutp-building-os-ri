...
詳細は [oss-tier-architecture.md](../architecture/oss-tier-architecture.md) と [oss-sla-freshness.md](../operations/oss-sla-freshness.md) を参照してください。
...
制御フローの詳細は [oss-control-safety.md](../architecture/oss-control-safety.md) を参照してください。
...
- [telemetry-specification.md](../architecture/telemetry-specification.md) — テレメトリフィールド契約
- [oss-tier-architecture.md](../architecture/oss-tier-architecture.md) — Hot/Warm/Cold 階層と API の選択基準
- [oss-control-safety.md](../architecture/oss-control-safety.md) — 制御系の権限・安全分界・監査
- [gateway-integration.md](gateway-integration.md) — ゲートウェイ API・ETag・mTLS
- [standard-mapping.md](../architecture/standard-mapping.md) — リソース表現（SBCO/Brick/REC/DTDL 対応表）
