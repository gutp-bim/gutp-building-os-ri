...
[`docs/operations/keycloak-permission-mapping.md`](../operations/keycloak-permission-mapping.md) を参照してください。
...
- [`docs/guides/getting-started.md`](getting-started.md) — オンボーディング（起動→API/Web→投入→読取/制御）
- [`docs/guides/gateway-integration.md`](gateway-integration.md) — ゲートウェイ接続モデル（ingress/egress・point list 同期・mTLS）
- [`docs/guides/keycloak-user-management.md`](keycloak-user-management.md) — ユーザ管理・ロール・トークン
- [`docs/architecture/system-architecture.md`](../architecture/system-architecture.md) — 全体構成
- [`docs/reference/evaluation-summary.md`](../reference/evaluation-summary.md) — E2E 評価結果
