...
[system-architecture.md](../architecture/system-architecture.md)、ゲートウェイ接続は
[gateway-integration.md](gateway-integration.md)、性能・妥当性は
[evaluation-summary.md](../reference/evaluation-summary.md) を参照してください。
...
詳細は [oss-tier-architecture.md](../architecture/oss-tier-architecture.md)（Hot/Warm/Cold 階層）と
[oss-warm-parquet-lake.md](../architecture/oss-warm-parquet-lake.md)（既定の Parquet レイク）。
...
- [system-architecture.md](../architecture/system-architecture.md) — 全体構成・データ/制御フロー・セキュリティ
- [evaluation-summary.md](../reference/evaluation-summary.md) — E2E 評価の結果と、アーキテクチャ/性能の妥当性
