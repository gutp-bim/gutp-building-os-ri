...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH25 = '/buildings';
  const PATH26 = '/metadata';
  const PATH27 = '/device-details';
  const PATH28 = '/devices';
  const PATH29 = '/floors';
  const PATH30 = '/gateways';
  const PATH31 = '/pointlist';
  const PATH32 = '/point-details';
  const PATH33 = '/points';
  const PATH34 = '/control';
  const PATH35 = '/control-audit';
  const PATH36 = '/resources/search';
  const PATH37 = '/spaces';
  const PATH38 = '/telemetries/query';
  const PATH39 = '/telemetries/query/batch-latest';
  const GET = 'GET';
  const POST = 'POST';
  const PUT = 'PUT';
  const DELETE = 'DELETE';
  ...
  return {
    ...
    buildings: {
      _buildingDtId: (val1: string) => {
        ...
        return {
          metadata: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_a63ipz['get']['resBody'], BasicHeaders, Methods_a63ipz['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_a63ipz['get']['resBody'], BasicHeaders, Methods_a63ipz['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json().then(r => r.body),
            patch: (option: { body: Methods_a63ipz['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_a63ipz['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send(),
            $patch: (option: { body: Methods_a63ipz['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_a63ipz['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send().then(r => r.body),
       ...
       */
      get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_ok90xj['get']['resBody'], BasicHeaders, Methods_ok90xj['get']['status']>(prefix, PATH25, GET, option).json(),
      /**
       * @returns OK
       */
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_ok90xj['get']['resBody'], BasicHeaders, Methods_ok90xj['get']['status']>(prefix, PATH25, GET, option).json().then(r => r.body),
      $path: () => `${prefix}${PATH25}`,
    },
    device_details: {
      /**
      ...
      get: (option?: { query?: Methods_7yye3n['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_7yye3n['get']['resBody'], BasicHeaders, Methods_7yye3n['get']['status']>(prefix, PATH27, GET, option).json(),
      /**
       * @returns OK
       */
      $get: (option?: { query?: Methods_7yye3n['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_7yye3n['get']['resBody'], BasicHeaders, Methods_7yye3n['get']['status']>(prefix, PATH27, GET, option).json().then(r => r.body),
    ...
    devices: {
      _deviceDtId: (val1: string) => {
        ...
        return {
          metadata: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1l25dyr['get']['resBody'], BasicHeaders, Methods_1l25dyr['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1l25dyr['get']['resBody'], BasicHeaders, Methods_1l25dyr['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json().then(r => r.body),
            patch: (option: { body: Methods_1l25dyr['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_1l25dyr['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send(),
            $patch: (option: { body: Methods_1l25dyr['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_1l25dyr['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send().then(r => r.body),
            $path: () => `${prefix}${prefix1}${PATH26}`,
          },
          /**
           * @returns OK
      ...
      get: (option?: { query?: Methods_39vmi5['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_39vmi5['get']['resBody'], BasicHeaders, Methods_39vmi5['get']['status']>(prefix, PATH28, GET, option).json(),
      /**
       * @returns OK
       */
      $get: (option?: { query?: Methods_39vmi5['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_39vmi5['get']['resBody'], BasicHeaders, Methods_39vmi5['get']['status']>(prefix, PATH28, GET, option).json().then(r => r.body),
    ...
    floors: {
      _floorDtId: (val1: string) => {
        ...
        return {
          metadata: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_11vktvx['get']['resBody'], BasicHeaders, Methods_11vktvx['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_11vktvx['get']['resBody'], BasicHeaders, Methods_11vktvx['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json().then(r => r.body),
            patch: (option: { body: Methods_11vktvx['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_11vktvx['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send(),
            $patch: (option: { body: Methods_11vktvx['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_11vktvx['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send().then(r => r.body),
            $path: () => `${prefix}${prefix1}${PATH26}`,
          },
          /**
           * @returns OK
      ...
      get: (option?: { query?: Methods_z40s5x['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_z40s5x['get']['resBody'], BasicHeaders, Methods_z40s5x['get']['status']>(prefix, PATH29, GET, option).json(),
      /**
       * @returns OK
       */
      $get: (option?: { query?: Methods_z40s5x['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_z40s5x['get']['resBody'], BasicHeaders, Methods_z40s5x['get']['status']>(prefix, PATH29, GET, option).json().then(r => r.body),
    ...
    point_details: {
      ...
      get: (option?: { query?: Methods_19trvk3['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_19trvk3['get']['resBody'], BasicHeaders, Methods_19trvk3['get']['status']>(prefix, PATH32, GET, option).json(),
      /**
       * @returns OK
       */
      $get: (option?: { query?: Methods_19trvk3['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_19trvk3['get']['resBody'], BasicHeaders, Methods_19trvk3['get']['status']>(prefix, PATH32, GET, option).json().then(r => r.body),
    ...
    points: {
        ...
        return {
          control: {
            ...
            post: (option: { body: Methods_ky3pcp['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_ky3pcp['post']['resBody'], BasicHeaders, Methods_ky3pcp['post']['status']>(prefix, `${prefix1}${PATH34}`, POST, option).json(),
            /**
             * @returns Accepted
             */
            $post: (option: { body: Methods_ky3pcp['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_ky3pcp['post']['resBody'], BasicHeaders, Methods_ky3pcp['post']['status']>(prefix, `${prefix1}${PATH34}`, POST, option).json().then(r => r.body),
          ...
          control_audit: {
            ...
            get: (option?: { query?: Methods_1tjp38b['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_1tjp38b['get']['resBody'], BasicHeaders, Methods_1tjp38b['get']['status']>(prefix, `${prefix1}${PATH35}`, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { query?: Methods_1tjp38b['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_1tjp38b['get']['resBody'], BasicHeaders, Methods_1tjp38b['get']['status']>(prefix, `${prefix1}${PATH35}`, GET, option).json().then(r => r.body),
          ...
          metadata: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_mu5l1t['get']['resBody'], BasicHeaders, Methods_mu5l1t['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_mu5l1t['get']['resBody'], BasicHeaders, Methods_mu5l1t['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json().then(r => r.body),
            patch: (option: { body: Methods_mu5l1t['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_mu5l1t['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send(),
            $patch: (option: { body: Methods_mu5l1t['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_mu5l1t['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send().then(r => r.body),
            $path: () => `${prefix}${prefix1}${PATH26}`,
          },
          /**
           * @returns OK
      ...
      get: (option?: { query?: Methods_13o0dsd['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_13o0dsd['get']['resBody'], BasicHeaders, Methods_13o0dsd['get']['status']>(prefix, PATH33, GET, option).json(),
      /**
       * @returns OK
       */
      $get: (option?: { query?: Methods_13o0dsd['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_13o0dsd['get']['resBody'], BasicHeaders, Methods_13o0dsd['get']['status']>(prefix, PATH33, GET, option).json().then(r => r.body),
    ...
    resources: {
      search: {
        ...
        get: (option?: { query?: Methods_v8c4mg['get']['query'] | undefined, config?: T | undefined } | undefined) =>
          fetch<Methods_v8c4mg['get']['resBody'], BasicHeaders, Methods_v8c4mg['get']['status']>(prefix, PATH36, GET, option).json(),
        /**
         * @returns OK
         */
        $get: (option?: { query?: Methods_v8c4mg['get']['query'] | undefined, config?: T | undefined } | undefined) =>
          fetch<Methods_v8c4mg['get']['resBody'], BasicHeaders, Methods_v8c4mg['get']['status']>(prefix, PATH36, GET, option).json().then(r => r.body),
    ...
    spaces: {
      _spaceDtId: (val1: string) => {
        ...
        return {
          metadata: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1pv2qv1['get']['resBody'], BasicHeaders, Methods_1pv2qv1['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json(),
            /**
             * @returns OK
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1pv2qv1['get']['resBody'], BasicHeaders, Methods_1pv2qv1['get']['status']>(prefix, `${prefix1}${PATH26}`, GET, option).json().then(r => r.body),
            patch: (option: { body: Methods_1pv2qv1['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_1pv2qv1['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send(),
            $patch: (option: { body: Methods_1pv2qv1['patch']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods_1pv2qv1['patch']['status']>(prefix, `${prefix1}${PATH26}`, PATCH, option).send().then(r => r.body),
            $path: () => `${prefix}${prefix1}${PATH26}`,
          },
          /**
           * @returns OK
      ...
      get: (option?: { query?: Methods_kbl8x1['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_kbl8x1['get']['resBody'], BasicHeaders, Methods_kbl8x1['get']['status']>(prefix, PATH37, GET, option).json(),
      /**
       * @returns OK
       */
      $get: (option?: { query?: Methods_kbl8x1['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_kbl8x1['get']['resBody'], BasicHeaders, Methods_kbl8x1['get']['status']>(prefix, PATH37, GET, option).json().then(r => r.body),
      ...
      query: {
        batch_latest: {
          ...
          post: (option: { body: Methods_1dmkv0v['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1dmkv0v['post']['resBody'], BasicHeaders, Methods_1dmkv0v['post']['status']>(prefix, PATH39, POST, option).json(),
          /**
           * @returns OK
           */
          $post: (option: { body: Methods_1dmkv0v['post']['reqBody'], config?: T | undefined }) =>
            fetch<Methods_1dmkv0v['post']['resBody'], BasicHeaders, Methods_1dmkv0v['post']['status']>(prefix, PATH39, POST, option).json().then(r => r.body),
          $path: () => `${prefix}${PATH39}`,
        },
        /**
         * @returns OK
        ...
        get: (option?: { query?: Methods_8ytsl6['get']['query'] | undefined, config?: T | undefined } | undefined) =>
          fetch<Methods_8ytsl6['get']['resBody'], BasicHeaders, Methods_8ytsl6['get']['status']>(prefix, PATH38, GET, option).json(),
        /**
         * @returns OK
         */
        $get: (option?: { query?: Methods_8ytsl6['get']['query'] | undefined, config?: T | undefined } | undefined) =>
          fetch<Methods_8ytsl6['get']['resBody'], BasicHeaders, Methods_8ytsl6['get']['status']>(prefix, PATH38, GET, option).json().then(r => r.body),
