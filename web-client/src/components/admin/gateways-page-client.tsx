  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4 text-sm text-gray-600">
        binding / 接続設定（シークレットはマスク）と pointlist
      ...
      {gateways === null ? (
        ...
        <p className="text-gray-600" data-testid="gw-empty">
          ツインにゲートウェイが登録されていません
        </p>
      ) : (
            ...
            <tbody>
              {gateways.map((gw) => (
                <tr
                  ...
                  data-testid={`gw-row-${gw.gatewayId}`}
                >
                  ...
                  <td
                    ...
                    data-testid={`gw-last-seen-${gw.gatewayId}`}
                  >
                    {lastSeenLabel(gw.lastTelemetryAt)}
                  </td>
                  <td className="px-3 py-2 font-mono text-xs text-gray-700">
                    {shortRevision(gw.revision)}
                  </td>
