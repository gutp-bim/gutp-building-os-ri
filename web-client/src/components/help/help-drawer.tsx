 ...
 * is owned by the parent. The overlay/scrim + dialog a11y (focus trap, Esc, focus restoration) come
 * from the shared {@link Dialog} primitive (#194).
 */
export function HelpDrawer({
  ...
  return (
    <Dialog
      ...
      labelledBy={entry ? "help-drawer-title" : undefined}
      label={entry ? undefined : "ヘルプ"}
      scrimLabel="ヘルプを閉じる"
      panelClassName="flex w-full max-w-md flex-col overflow-auto bg-white p-5 shadow-xl"
      testId="help-drawer"
    >
      {entry === null ? (
          ...
          {terms.length > 0 && (
            <div className="mt-5">
              ...
              <dl
                ...
                data-testid="help-related-terms"
              >
                {terms.map((t) => (
                  <div key={t.term}>
