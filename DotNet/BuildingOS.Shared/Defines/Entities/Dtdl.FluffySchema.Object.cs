...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct FluffySchema : IJsonObject<FluffySchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "FluffySchema"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FluffySchema(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator FluffySchema(JsonObject value)
        {
        ...
        public static FluffySchema FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FluffySchema FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FluffySchema FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public FluffySchema SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public FluffySchema RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FluffySchema RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FluffySchema RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FluffySchema RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
