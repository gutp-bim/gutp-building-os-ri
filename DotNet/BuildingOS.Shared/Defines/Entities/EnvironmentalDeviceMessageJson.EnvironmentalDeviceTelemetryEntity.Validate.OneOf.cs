...
public readonly partial struct EnvironmentalDeviceMessageJson
{
    ...
    public readonly partial struct EnvironmentalDeviceTelemetryEntity
    {
        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext oneOfResult0 = this.As<BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity.OneOf0Entity>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext oneOfResult1 = this.As<BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity.OneOf1Entity>().Validate(childContext1.CreateChildContext(), level);
