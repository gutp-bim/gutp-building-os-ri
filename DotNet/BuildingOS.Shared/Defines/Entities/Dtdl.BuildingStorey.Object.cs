...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct BuildingStorey : IJsonObject<BuildingStorey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "BuildingStorey"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public BuildingStorey(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator BuildingStorey(JsonObject value)
        {
        ...
        public static BuildingStorey FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static BuildingStorey FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static BuildingStorey FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public BuildingStorey SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public BuildingStorey RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public BuildingStorey RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public BuildingStorey RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public BuildingStorey RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
