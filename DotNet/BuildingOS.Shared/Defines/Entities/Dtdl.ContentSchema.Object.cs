...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct ContentSchema : IJsonObject<ContentSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ContentSchema"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ContentSchema(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ContentSchema(JsonObject value)
        {
        ...
        public static ContentSchema FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ContentSchema FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ContentSchema FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ContentSchema SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ContentSchema RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ContentSchema RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ContentSchema RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ContentSchema RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
