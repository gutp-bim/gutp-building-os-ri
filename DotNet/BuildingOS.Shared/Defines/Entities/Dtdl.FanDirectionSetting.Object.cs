...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct FanDirectionSetting : IJsonObject<FanDirectionSetting>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "FanDirectionSetting"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FanDirectionSetting(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator FanDirectionSetting(JsonObject value)
        {
        ...
        public static FanDirectionSetting FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FanDirectionSetting FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FanDirectionSetting FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public FanDirectionSetting SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public FanDirectionSetting RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FanDirectionSetting RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FanDirectionSetting RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FanDirectionSetting RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
