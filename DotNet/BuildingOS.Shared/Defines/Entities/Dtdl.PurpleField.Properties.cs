...
public readonly partial struct Dtdl
{
    ...
    public readonly partial struct PurpleField
    {
        ...
        /// Gets Schema.
        /// </summary>
        public BuildingOS.Shared.Entities.Dtdl.StickySchema Schema
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    ...
                    {
                        return new BuildingOS.Shared.Entities.Dtdl.StickySchema(result);
                    }
                }
                ...
                if ((this.backing & Backing.Object) != 0)
                {
                    ...
                    {
                        return result.As<BuildingOS.Shared.Entities.Dtdl.StickySchema>();
                    }
                }
        ...
        /// <summary>
        /// Creates an instance of a <see cref = "PurpleField"/>.
        /// </summary>
        public static PurpleField Create(Corvus.Json.JsonString name, BuildingOS.Shared.Entities.Dtdl.StickySchema schema)
        {
        ...
        public PurpleField WithName(in Corvus.Json.JsonString value)
        {
        ...
        /// <param name = "value">The value to set.</param>
        /// <returns>The entity with the updated property.</returns>
        public PurpleField WithSchema(in BuildingOS.Shared.Entities.Dtdl.StickySchema value)
        {
        ...
        {
            return property.ValueAs<BuildingOS.Shared.Entities.Dtdl.StickySchema>().Validate(validationContext, level);
        }
