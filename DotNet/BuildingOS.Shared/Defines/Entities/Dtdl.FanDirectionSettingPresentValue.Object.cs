...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct FanDirectionSettingPresentValue : IJsonObject<FanDirectionSettingPresentValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "FanDirectionSettingPresentValue"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FanDirectionSettingPresentValue(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator FanDirectionSettingPresentValue(JsonObject value)
        {
        ...
        public static FanDirectionSettingPresentValue FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FanDirectionSettingPresentValue FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FanDirectionSettingPresentValue FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public FanDirectionSettingPresentValue SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public FanDirectionSettingPresentValue RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FanDirectionSettingPresentValue RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FanDirectionSettingPresentValue RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FanDirectionSettingPresentValue RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
