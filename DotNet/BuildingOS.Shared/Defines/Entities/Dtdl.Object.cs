...
/// </summary>
public readonly partial struct Dtdl : IJsonObject<Dtdl>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "Dtdl"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public Dtdl(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator Dtdl(JsonObject value)
    {
    ...
    public static Dtdl FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static Dtdl FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static Dtdl FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public Dtdl SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public Dtdl RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public Dtdl RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public Dtdl RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public Dtdl RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
