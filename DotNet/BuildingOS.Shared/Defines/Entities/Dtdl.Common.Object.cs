...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct Common : IJsonObject<Common>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "Common"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public Common(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator Common(JsonObject value)
        {
        ...
        public static Common FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static Common FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static Common FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public Common SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public Common RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Common RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Common RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Common RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
