...
public readonly partial struct Dtdl
{
    public readonly partial struct DigitalTwinsGraph
    {
        ...
        /// </summary>
        public readonly partial struct RelationshipArray : IJsonArray<RelationshipArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly RelationshipArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "RelationshipArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public RelationshipArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public RelationshipArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<RelationshipArray>.this[int index]
            {
                get
                {
            ...
            public BuildingOS.Shared.Entities.Dtdl.Relationship this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new BuildingOS.Shared.Entities.Dtdl.Relationship(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<BuildingOS.Shared.Entities.Dtdl.Relationship>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(RelationshipArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator RelationshipArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator RelationshipArray(JsonArray value)
            {
            ...
            public static RelationshipArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            /// <returns>A RelationshipArray instantiated from the given items.</returns>
            public static RelationshipArray FromItems(in BuildingOS.Shared.Entities.Dtdl.Relationship value1)
            {
            ...
            /// <returns>A RelationshipArray instantiated from the given items.</returns>
            public static RelationshipArray FromItems(in BuildingOS.Shared.Entities.Dtdl.Relationship value1, in BuildingOS.Shared.Entities.Dtdl.Relationship value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A RelationshipArray instantiated from the given items.</returns>
            public static RelationshipArray FromItems(in BuildingOS.Shared.Entities.Dtdl.Relationship value1, in BuildingOS.Shared.Entities.Dtdl.Relationship value2, in BuildingOS.Shared.Entities.Dtdl.Relationship value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static RelationshipArray FromItems(params BuildingOS.Shared.Entities.Dtdl.Relationship[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.Relationship item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static RelationshipArray FromRange(IEnumerable<BuildingOS.Shared.Entities.Dtdl.Relationship> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.Relationship item in value)
                {
            ...
            /// </remarks>
            public static RelationshipArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new RelationshipArray(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static RelationshipArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static RelationshipArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.Relationship> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.Relationship>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.Relationship>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<RelationshipArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<RelationshipArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
