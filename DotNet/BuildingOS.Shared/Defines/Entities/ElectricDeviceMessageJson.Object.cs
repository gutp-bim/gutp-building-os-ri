...
/// </summary>
public readonly partial struct ElectricDeviceMessageJson : IJsonObject<ElectricDeviceMessageJson>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "ElectricDeviceMessageJson"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public ElectricDeviceMessageJson(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator ElectricDeviceMessageJson(JsonObject value)
    {
    ...
    public static ElectricDeviceMessageJson FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static ElectricDeviceMessageJson FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static ElectricDeviceMessageJson FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public ElectricDeviceMessageJson SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public ElectricDeviceMessageJson RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public ElectricDeviceMessageJson RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public ElectricDeviceMessageJson RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public ElectricDeviceMessageJson RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
