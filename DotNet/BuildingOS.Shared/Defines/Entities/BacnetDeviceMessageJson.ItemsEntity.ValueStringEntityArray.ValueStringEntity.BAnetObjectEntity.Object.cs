    ...
    public readonly partial struct ItemsEntity
    {
        public readonly partial struct ValueStringEntityArray
        {
            public readonly partial struct ValueStringEntity
            {
                ...
                /// </summary>
                public readonly partial struct BAnetObjectEntity : IJsonObject<BAnetObjectEntity>
                {
                    /// <summary>
                    /// Initializes a new instance of the <see cref = "BAnetObjectEntity"/> struct.
                    /// </summary>
                    /// <param name = "value">The value from which to construct the instance.</param>
                    public BAnetObjectEntity(ImmutableList<JsonObjectProperty> value)
                    {
                    ...
                    public static implicit operator BAnetObjectEntity(JsonObject value)
                    {
                    ...
                    public static BAnetObjectEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                    {
                    ...
                    /// <param name = "source">The dictionary of properties.</param>
                    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                    public static BAnetObjectEntity FromProperties(ImmutableList<JsonObjectProperty> source)
                    {
                        return new(source);
                    }
                    ...
                    /// <param name = "source">The dictionary of properties.</param>
                    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                    public static BAnetObjectEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                    {
                    ...
                    /// <inheritdoc/>
                    public BAnetObjectEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
                    ...
                    /// <inheritdoc/>
                    public BAnetObjectEntity RemoveProperty(in JsonPropertyName name)
                    {
                        return new(this.GetPropertyBackingWithout(name));
                    }

                    /// <inheritdoc/>
                    public BAnetObjectEntity RemoveProperty(string name)
                    {
                        return new(this.GetPropertyBackingWithout(name));
                    }

                    /// <inheritdoc/>
                    public BAnetObjectEntity RemoveProperty(ReadOnlySpan<char> name)
                    {
                        return new(this.GetPropertyBackingWithout(name));
                    }

                    /// <inheritdoc/>
                    public BAnetObjectEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
                    {
