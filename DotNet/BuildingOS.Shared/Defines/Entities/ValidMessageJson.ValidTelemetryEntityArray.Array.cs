...
public readonly partial struct ValidMessageJson
{
    ...
    /// </summary>
    public readonly partial struct ValidTelemetryEntityArray : IJsonArray<ValidTelemetryEntityArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ValidTelemetryEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValidTelemetryEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValidTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValidTelemetryEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<ValidTelemetryEntityArray>.this[int index]
        {
            get
            {
        ...
        public BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(ValidTelemetryEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValidTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ValidTelemetryEntityArray(JsonArray value)
        {
        ...
        public static ValidTelemetryEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ValidTelemetryEntityArray instantiated from the given items.</returns>
        public static ValidTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity value1)
        {
        ...
        /// <returns>A ValidTelemetryEntityArray instantiated from the given items.</returns>
        public static ValidTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity value1, in BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ValidTelemetryEntityArray instantiated from the given items.</returns>
        public static ValidTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity value1, in BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity value2, in BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ValidTelemetryEntityArray FromItems(params BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ValidTelemetryEntityArray FromRange(IEnumerable<BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity item in value)
            {
        ...
        /// </remarks>
        public static ValidTelemetryEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ValidTelemetryEntityArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ValidTelemetryEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ValidTelemetryEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.ValidMessageJson.ValidTelemetryEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ValidTelemetryEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ValidTelemetryEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
