...
public readonly partial struct ElectricDeviceMessageJson
{
    ...
    /// </summary>
    public readonly partial struct ElectricDeviceTelemetryEntity : IJsonObject<ElectricDeviceTelemetryEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ElectricDeviceTelemetryEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ElectricDeviceTelemetryEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ElectricDeviceTelemetryEntity(JsonObject value)
        {
        ...
        public static ElectricDeviceTelemetryEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ElectricDeviceTelemetryEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ElectricDeviceTelemetryEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ElectricDeviceTelemetryEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ElectricDeviceTelemetryEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ElectricDeviceTelemetryEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ElectricDeviceTelemetryEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ElectricDeviceTelemetryEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
