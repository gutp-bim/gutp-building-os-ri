...
/// </summary>
public readonly partial struct HvacDeviceMessageJson : IJsonObject<HvacDeviceMessageJson>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "HvacDeviceMessageJson"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public HvacDeviceMessageJson(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator HvacDeviceMessageJson(JsonObject value)
    {
    ...
    public static HvacDeviceMessageJson FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static HvacDeviceMessageJson FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static HvacDeviceMessageJson FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public HvacDeviceMessageJson SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public HvacDeviceMessageJson RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public HvacDeviceMessageJson RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public HvacDeviceMessageJson RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public HvacDeviceMessageJson RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
