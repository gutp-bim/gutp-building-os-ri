...
public readonly partial struct EnvironmentalDeviceMessageJson
{
    ...
    /// </summary>
    public readonly partial struct EnvironmentalDeviceTelemetryEntityArray : IJsonArray<EnvironmentalDeviceTelemetryEntityArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly EnvironmentalDeviceTelemetryEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "EnvironmentalDeviceTelemetryEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EnvironmentalDeviceTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EnvironmentalDeviceTelemetryEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<EnvironmentalDeviceTelemetryEntityArray>.this[int index]
        {
            get
            {
        ...
        public BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(EnvironmentalDeviceTelemetryEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EnvironmentalDeviceTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EnvironmentalDeviceTelemetryEntityArray(JsonArray value)
        {
        ...
        public static EnvironmentalDeviceTelemetryEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A EnvironmentalDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static EnvironmentalDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity value1)
        {
        ...
        /// <returns>A EnvironmentalDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static EnvironmentalDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity value1, in BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EnvironmentalDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static EnvironmentalDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity value1, in BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity value2, in BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EnvironmentalDeviceTelemetryEntityArray FromItems(params BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EnvironmentalDeviceTelemetryEntityArray FromRange(IEnumerable<BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity item in value)
            {
        ...
        /// </remarks>
        public static EnvironmentalDeviceTelemetryEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new EnvironmentalDeviceTelemetryEntityArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EnvironmentalDeviceTelemetryEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EnvironmentalDeviceTelemetryEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.EnvironmentalDeviceMessageJson.EnvironmentalDeviceTelemetryEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<EnvironmentalDeviceTelemetryEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<EnvironmentalDeviceTelemetryEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
