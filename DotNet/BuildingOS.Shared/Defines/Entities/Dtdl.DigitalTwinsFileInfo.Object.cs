...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct DigitalTwinsFileInfo : IJsonObject<DigitalTwinsFileInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DigitalTwinsFileInfo"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DigitalTwinsFileInfo(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator DigitalTwinsFileInfo(JsonObject value)
        {
        ...
        public static DigitalTwinsFileInfo FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwinsFileInfo FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwinsFileInfo FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DigitalTwinsFileInfo SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public DigitalTwinsFileInfo RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsFileInfo RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsFileInfo RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsFileInfo RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
