...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct Relationship : IJsonObject<Relationship>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "Relationship"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public Relationship(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator Relationship(JsonObject value)
        {
        ...
        public static Relationship FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static Relationship FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static Relationship FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public Relationship SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public Relationship RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Relationship RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Relationship RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Relationship RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
