...
public readonly partial struct Dtdl
{
    public readonly partial struct DigitalTwinsGraph
    {
        ...
        /// </summary>
        public readonly partial struct DigitalTwinArray : IJsonArray<DigitalTwinArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly DigitalTwinArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "DigitalTwinArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DigitalTwinArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public DigitalTwinArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<DigitalTwinArray>.this[int index]
            {
                get
                {
            ...
            public BuildingOS.Shared.Entities.Dtdl.DigitalTwin this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new BuildingOS.Shared.Entities.Dtdl.DigitalTwin(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<BuildingOS.Shared.Entities.Dtdl.DigitalTwin>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(DigitalTwinArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator DigitalTwinArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator DigitalTwinArray(JsonArray value)
            {
            ...
            public static DigitalTwinArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            /// <returns>A DigitalTwinArray instantiated from the given items.</returns>
            public static DigitalTwinArray FromItems(in BuildingOS.Shared.Entities.Dtdl.DigitalTwin value1)
            {
            ...
            /// <returns>A DigitalTwinArray instantiated from the given items.</returns>
            public static DigitalTwinArray FromItems(in BuildingOS.Shared.Entities.Dtdl.DigitalTwin value1, in BuildingOS.Shared.Entities.Dtdl.DigitalTwin value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A DigitalTwinArray instantiated from the given items.</returns>
            public static DigitalTwinArray FromItems(in BuildingOS.Shared.Entities.Dtdl.DigitalTwin value1, in BuildingOS.Shared.Entities.Dtdl.DigitalTwin value2, in BuildingOS.Shared.Entities.Dtdl.DigitalTwin value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static DigitalTwinArray FromItems(params BuildingOS.Shared.Entities.Dtdl.DigitalTwin[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.DigitalTwin item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static DigitalTwinArray FromRange(IEnumerable<BuildingOS.Shared.Entities.Dtdl.DigitalTwin> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.DigitalTwin item in value)
                {
            ...
            /// </remarks>
            public static DigitalTwinArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new DigitalTwinArray(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static DigitalTwinArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static DigitalTwinArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.DigitalTwin> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.DigitalTwin>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.DigitalTwin>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<DigitalTwinArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<DigitalTwinArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
