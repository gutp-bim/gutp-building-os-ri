...
public readonly partial struct Dtdl
{
    public readonly partial struct FluffySchema
    {
        ...
        /// </summary>
        public readonly partial struct EnumValueArray : IJsonArray<EnumValueArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly EnumValueArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "EnumValueArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public EnumValueArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public EnumValueArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<EnumValueArray>.this[int index]
            {
                get
                {
            ...
            public BuildingOS.Shared.Entities.Dtdl.EnumValue this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new BuildingOS.Shared.Entities.Dtdl.EnumValue(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<BuildingOS.Shared.Entities.Dtdl.EnumValue>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(EnumValueArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator EnumValueArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator EnumValueArray(JsonArray value)
            {
            ...
            public static EnumValueArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            /// <returns>A EnumValueArray instantiated from the given items.</returns>
            public static EnumValueArray FromItems(in BuildingOS.Shared.Entities.Dtdl.EnumValue value1)
            {
            ...
            /// <returns>A EnumValueArray instantiated from the given items.</returns>
            public static EnumValueArray FromItems(in BuildingOS.Shared.Entities.Dtdl.EnumValue value1, in BuildingOS.Shared.Entities.Dtdl.EnumValue value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A EnumValueArray instantiated from the given items.</returns>
            public static EnumValueArray FromItems(in BuildingOS.Shared.Entities.Dtdl.EnumValue value1, in BuildingOS.Shared.Entities.Dtdl.EnumValue value2, in BuildingOS.Shared.Entities.Dtdl.EnumValue value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static EnumValueArray FromItems(params BuildingOS.Shared.Entities.Dtdl.EnumValue[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.EnumValue item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static EnumValueArray FromRange(IEnumerable<BuildingOS.Shared.Entities.Dtdl.EnumValue> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.EnumValue item in value)
                {
            ...
            /// </remarks>
            public static EnumValueArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new EnumValueArray(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static EnumValueArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static EnumValueArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.EnumValue> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.EnumValue>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.EnumValue>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<EnumValueArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<EnumValueArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
