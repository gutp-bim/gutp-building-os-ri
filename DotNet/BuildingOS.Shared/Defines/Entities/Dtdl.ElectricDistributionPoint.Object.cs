...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct ElectricDistributionPoint : IJsonObject<ElectricDistributionPoint>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ElectricDistributionPoint"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ElectricDistributionPoint(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ElectricDistributionPoint(JsonObject value)
        {
        ...
        public static ElectricDistributionPoint FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ElectricDistributionPoint FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ElectricDistributionPoint FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ElectricDistributionPoint SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ElectricDistributionPoint RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ElectricDistributionPoint RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ElectricDistributionPoint RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ElectricDistributionPoint RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
