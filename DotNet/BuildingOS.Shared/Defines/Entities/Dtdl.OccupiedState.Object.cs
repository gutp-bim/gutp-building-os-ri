...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct OccupiedState : IJsonObject<OccupiedState>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "OccupiedState"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public OccupiedState(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator OccupiedState(JsonObject value)
        {
        ...
        public static OccupiedState FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static OccupiedState FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static OccupiedState FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public OccupiedState SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public OccupiedState RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public OccupiedState RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public OccupiedState RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public OccupiedState RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
