...
public readonly partial struct ElectricDeviceMessageJson
{
    ...
    /// </summary>
    public readonly partial struct ElectricDeviceTelemetryEntityArray : IJsonArray<ElectricDeviceTelemetryEntityArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ElectricDeviceTelemetryEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ElectricDeviceTelemetryEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ElectricDeviceTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ElectricDeviceTelemetryEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<ElectricDeviceTelemetryEntityArray>.this[int index]
        {
            get
            {
        ...
        public BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(ElectricDeviceTelemetryEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ElectricDeviceTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ElectricDeviceTelemetryEntityArray(JsonArray value)
        {
        ...
        public static ElectricDeviceTelemetryEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ElectricDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static ElectricDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity value1)
        {
        ...
        /// <returns>A ElectricDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static ElectricDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity value1, in BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ElectricDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static ElectricDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity value1, in BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity value2, in BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ElectricDeviceTelemetryEntityArray FromItems(params BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ElectricDeviceTelemetryEntityArray FromRange(IEnumerable<BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity item in value)
            {
        ...
        /// </remarks>
        public static ElectricDeviceTelemetryEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ElectricDeviceTelemetryEntityArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ElectricDeviceTelemetryEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ElectricDeviceTelemetryEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.ElectricDeviceMessageJson.ElectricDeviceTelemetryEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ElectricDeviceTelemetryEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ElectricDeviceTelemetryEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
