...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct DigitalTwin : IJsonObject<DigitalTwin>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DigitalTwin"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DigitalTwin(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator DigitalTwin(JsonObject value)
        {
        ...
        public static DigitalTwin FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwin FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwin FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DigitalTwin SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public DigitalTwin RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwin RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwin RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwin RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
