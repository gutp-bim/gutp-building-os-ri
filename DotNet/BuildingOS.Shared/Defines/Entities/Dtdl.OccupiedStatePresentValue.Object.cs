...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct OccupiedStatePresentValue : IJsonObject<OccupiedStatePresentValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "OccupiedStatePresentValue"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public OccupiedStatePresentValue(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator OccupiedStatePresentValue(JsonObject value)
        {
        ...
        public static OccupiedStatePresentValue FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static OccupiedStatePresentValue FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static OccupiedStatePresentValue FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public OccupiedStatePresentValue SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public OccupiedStatePresentValue RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public OccupiedStatePresentValue RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public OccupiedStatePresentValue RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public OccupiedStatePresentValue RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
