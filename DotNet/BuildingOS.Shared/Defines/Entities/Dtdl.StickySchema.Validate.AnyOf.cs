...
public readonly partial struct Dtdl
{
    ...
    public readonly partial struct StickySchema
    {
        private ValidationContext ValidateAnyOf(in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            ValidationContext anyOfResult0 = this.As<BuildingOS.Shared.Entities.Dtdl.PurpleSchema>().Validate(childContext0.CreateChildContext(), level);
            ...
            ValidationContext anyOfResult1 = this.As<Corvus.Json.JsonString>().Validate(childContext1.CreateChildContext(), level);
