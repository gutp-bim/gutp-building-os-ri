...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct IndigoSchema : IJsonObject<IndigoSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "IndigoSchema"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IndigoSchema(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator IndigoSchema(JsonObject value)
        {
        ...
        public static IndigoSchema FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static IndigoSchema FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static IndigoSchema FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public IndigoSchema SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public IndigoSchema RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public IndigoSchema RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public IndigoSchema RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public IndigoSchema RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
