...
/// </summary>
public readonly partial struct BacnetDeviceMessageJson : IJsonArray<BacnetDeviceMessageJson>
{
    /// <summary>
    /// Gets an empty array.
    /// </summary>
    public static readonly BacnetDeviceMessageJson EmptyArray = From(ImmutableList<JsonAny>.Empty);
    /// <summary>
    /// Initializes a new instance of the <see cref = "BacnetDeviceMessageJson"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public BacnetDeviceMessageJson(ImmutableList<JsonAny> value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public BacnetDeviceMessageJson(IEnumerable<JsonAny> value)
    {
        this.jsonElementBacking = default;
        this.backing = Backing.Array;
    ...
    /// <inheritdoc/>
    JsonAny IJsonArray<BacnetDeviceMessageJson>.this[int index]
    {
        get
        {
    ...
    public BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity this[int index]
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity(this.jsonElementBacking[index]);
            }
            ...
            if ((this.backing & Backing.Array) != 0)
            {
                try
                {
                    return this.arrayBacking[index].As<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity>();
                }
                catch (ArgumentOutOfRangeException ex)
                {
                    throw new IndexOutOfRangeException(ex.Message, ex);
    ...
    public static implicit operator ImmutableList<JsonAny>(BacnetDeviceMessageJson value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator BacnetDeviceMessageJson(ImmutableList<JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator BacnetDeviceMessageJson(JsonArray value)
    {
    ...
    public static BacnetDeviceMessageJson From(ImmutableList<JsonAny> items)
    {
        return new(items);
    }
    ...
    /// <returns>A BacnetDeviceMessageJson instantiated from the given items.</returns>
    public static BacnetDeviceMessageJson FromItems(in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity value1)
    {
    ...
    /// <returns>A BacnetDeviceMessageJson instantiated from the given items.</returns>
    public static BacnetDeviceMessageJson FromItems(in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity value1, in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity value2)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
    ...
    /// <returns>A BacnetDeviceMessageJson instantiated from the given items.</returns>
    public static BacnetDeviceMessageJson FromItems(in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity value1, in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity value2, in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity value3)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        builder.Add(value1.AsAny);
        builder.Add(value2.AsAny);
    ...
    public static BacnetDeviceMessageJson FromItems(params BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity[] value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity item in value)
        {
    ...
    /// <param name = "value">The value from which to construct the instance.</param>
    /// <returns>A JsonAny instantiated from the given items.</returns>
    public static BacnetDeviceMessageJson FromRange(IEnumerable<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity> value)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        foreach (BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity item in value)
        {
    ...
    /// </remarks>
    public static BacnetDeviceMessageJson From<T>(IEnumerable<T> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        return new BacnetDeviceMessageJson(builder.ToImmutable());
    }
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static BacnetDeviceMessageJson FromRange(IEnumerable<JsonAny> items)
    {
        ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
    ...
    /// other overloads which avoid this serialization step.
    /// </remarks>
    public static BacnetDeviceMessageJson FromRange<T>(IEnumerable<T> items)
    ...
    /// <inheritdoc/>
    public JsonArrayEnumerator<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity> EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
            return new JsonArrayEnumerator<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity>(this.jsonElementBacking);
        }

        if ((this.backing & Backing.Array) != 0)
        {
            return new JsonArrayEnumerator<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity>(this.arrayBacking);
        }
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator IJsonArray<BacnetDeviceMessageJson>.EnumerateArray()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
    ...
    /// <inheritdoc/>
    JsonArrayEnumerator<TItem> IJsonArray<BacnetDeviceMessageJson>.EnumerateArray<TItem>()
    {
        if ((this.backing & Backing.JsonElement) != 0)
        {
