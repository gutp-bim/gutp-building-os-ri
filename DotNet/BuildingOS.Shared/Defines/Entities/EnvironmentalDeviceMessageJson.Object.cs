...
/// </summary>
public readonly partial struct EnvironmentalDeviceMessageJson : IJsonObject<EnvironmentalDeviceMessageJson>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "EnvironmentalDeviceMessageJson"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public EnvironmentalDeviceMessageJson(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator EnvironmentalDeviceMessageJson(JsonObject value)
    {
    ...
    public static EnvironmentalDeviceMessageJson FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static EnvironmentalDeviceMessageJson FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static EnvironmentalDeviceMessageJson FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public EnvironmentalDeviceMessageJson SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public EnvironmentalDeviceMessageJson RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public EnvironmentalDeviceMessageJson RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public EnvironmentalDeviceMessageJson RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public EnvironmentalDeviceMessageJson RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
