...
public readonly partial struct BacnetDeviceMessageJson
{
    public readonly partial struct ItemsEntity
    {
        public readonly partial struct ValueStringEntityArray
        {
            ...
            /// </summary>
            public readonly partial struct ValueStringEntity : IJsonObject<ValueStringEntity>
            {
                /// <summary>
                /// Initializes a new instance of the <see cref = "ValueStringEntity"/> struct.
                /// </summary>
                /// <param name = "value">The value from which to construct the instance.</param>
                public ValueStringEntity(ImmutableList<JsonObjectProperty> value)
                {
                ...
                public static implicit operator ValueStringEntity(JsonObject value)
                {
                ...
                public static ValueStringEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
                {
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static ValueStringEntity FromProperties(ImmutableList<JsonObjectProperty> source)
                {
                    return new(source);
                }
                ...
                /// <param name = "source">The dictionary of properties.</param>
                /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
                public static ValueStringEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
                {
                ...
                /// <inheritdoc/>
                public ValueStringEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
                ...
                /// <inheritdoc/>
                public ValueStringEntity RemoveProperty(in JsonPropertyName name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public ValueStringEntity RemoveProperty(string name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public ValueStringEntity RemoveProperty(ReadOnlySpan<char> name)
                {
                    return new(this.GetPropertyBackingWithout(name));
                }

                /// <inheritdoc/>
                public ValueStringEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
                {
