        ...
        private ValidationContext ValidateObject(JsonValueKind valueKind, in ValidationContext validationContext, ValidationLevel level)
        {
            ...
            foreach (JsonObjectProperty property in this.EnumerateObject())
            {
                if (__TryGetCorvusLocalPropertiesValidator(property, this.HasJsonElementBacking, out ObjectPropertyValidator? propertyValidator))
                {
                    ...
                    if ((this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.FiapIdUtf8)) || (!this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.FiapId)))
                    {
                        foundFiapId = true;
                    }
                    ...
                    else if ((this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.TimeUtf8)) || (!this.HasJsonElementBacking && property.NameEquals(JsonPropertyNames.Time)))
                    {
                        foundTime = true;
                    }
            ...
            if (!foundFiapId)
            {
                if (level >= ValidationLevel.Detailed)
                {
                    result = result.WithResult(isValid: false, $"6.5.3. required - required property \"fiap_id\" not present.");
                }
                else if (level >= ValidationLevel.Basic)
                {
            ...
            if (!foundTime)
            {
                if (level >= ValidationLevel.Detailed)
                {
                    result = result.WithResult(isValid: false, $"6.5.3. required - required property \"time\" not present.");
                }
                else if (level >= ValidationLevel.Basic)
                {
                    result = result.WithResult(isValid: false, "6.5.3. required - required property not present.");
