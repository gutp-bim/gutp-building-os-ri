...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct StickySchema : IJsonObject<StickySchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "StickySchema"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public StickySchema(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator StickySchema(JsonObject value)
        {
        ...
        public static StickySchema FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static StickySchema FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static StickySchema FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public StickySchema SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public StickySchema RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public StickySchema RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public StickySchema RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public StickySchema RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
