...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct FluffyField : IJsonObject<FluffyField>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "FluffyField"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FluffyField(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator FluffyField(JsonObject value)
        {
        ...
        public static FluffyField FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FluffyField FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static FluffyField FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public FluffyField SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public FluffyField RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FluffyField RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FluffyField RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public FluffyField RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
