...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct Building : IJsonObject<Building>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "Building"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public Building(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator Building(JsonObject value)
        {
        ...
        public static Building FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static Building FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static Building FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public Building SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public Building RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Building RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Building RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public Building RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
