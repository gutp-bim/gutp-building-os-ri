...
public readonly partial struct Dtdl
{
    public readonly partial struct ContentSchema
    {
        ...
        /// </summary>
        public readonly partial struct PurpleFieldArray : IJsonArray<PurpleFieldArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly PurpleFieldArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "PurpleFieldArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public PurpleFieldArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public PurpleFieldArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<PurpleFieldArray>.this[int index]
            {
                get
                {
            ...
            public BuildingOS.Shared.Entities.Dtdl.PurpleField this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new BuildingOS.Shared.Entities.Dtdl.PurpleField(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<BuildingOS.Shared.Entities.Dtdl.PurpleField>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(PurpleFieldArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator PurpleFieldArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator PurpleFieldArray(JsonArray value)
            {
            ...
            public static PurpleFieldArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            /// <returns>A PurpleFieldArray instantiated from the given items.</returns>
            public static PurpleFieldArray FromItems(in BuildingOS.Shared.Entities.Dtdl.PurpleField value1)
            {
            ...
            /// <returns>A PurpleFieldArray instantiated from the given items.</returns>
            public static PurpleFieldArray FromItems(in BuildingOS.Shared.Entities.Dtdl.PurpleField value1, in BuildingOS.Shared.Entities.Dtdl.PurpleField value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A PurpleFieldArray instantiated from the given items.</returns>
            public static PurpleFieldArray FromItems(in BuildingOS.Shared.Entities.Dtdl.PurpleField value1, in BuildingOS.Shared.Entities.Dtdl.PurpleField value2, in BuildingOS.Shared.Entities.Dtdl.PurpleField value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static PurpleFieldArray FromItems(params BuildingOS.Shared.Entities.Dtdl.PurpleField[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.PurpleField item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static PurpleFieldArray FromRange(IEnumerable<BuildingOS.Shared.Entities.Dtdl.PurpleField> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.PurpleField item in value)
                {
            ...
            /// </remarks>
            public static PurpleFieldArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new PurpleFieldArray(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static PurpleFieldArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static PurpleFieldArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.PurpleField> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.PurpleField>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.PurpleField>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<PurpleFieldArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<PurpleFieldArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
