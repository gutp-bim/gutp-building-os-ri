...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct DigitalTwinsModelArray : IJsonArray<DigitalTwinsModelArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly DigitalTwinsModelArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "DigitalTwinsModelArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DigitalTwinsModelArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DigitalTwinsModelArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<DigitalTwinsModelArray>.this[int index]
        {
            get
            {
        ...
        public BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(DigitalTwinsModelArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator DigitalTwinsModelArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator DigitalTwinsModelArray(JsonArray value)
        {
        ...
        public static DigitalTwinsModelArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A DigitalTwinsModelArray instantiated from the given items.</returns>
        public static DigitalTwinsModelArray FromItems(in BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel value1)
        {
        ...
        /// <returns>A DigitalTwinsModelArray instantiated from the given items.</returns>
        public static DigitalTwinsModelArray FromItems(in BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel value1, in BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A DigitalTwinsModelArray instantiated from the given items.</returns>
        public static DigitalTwinsModelArray FromItems(in BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel value1, in BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel value2, in BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static DigitalTwinsModelArray FromItems(params BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static DigitalTwinsModelArray FromRange(IEnumerable<BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel item in value)
            {
        ...
        /// </remarks>
        public static DigitalTwinsModelArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new DigitalTwinsModelArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static DigitalTwinsModelArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static DigitalTwinsModelArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.DigitalTwinsModel>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<DigitalTwinsModelArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<DigitalTwinsModelArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
