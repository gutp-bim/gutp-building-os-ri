...
public readonly partial struct Dtdl
{
    public readonly partial struct DigitalTwinsModel
    {
        ...
        /// </summary>
        public readonly partial struct ContentArray : IJsonArray<ContentArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly ContentArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "ContentArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ContentArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ContentArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<ContentArray>.this[int index]
            {
                get
                {
            ...
            public BuildingOS.Shared.Entities.Dtdl.Content this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new BuildingOS.Shared.Entities.Dtdl.Content(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<BuildingOS.Shared.Entities.Dtdl.Content>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(ContentArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator ContentArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator ContentArray(JsonArray value)
            {
            ...
            public static ContentArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            /// <returns>A ContentArray instantiated from the given items.</returns>
            public static ContentArray FromItems(in BuildingOS.Shared.Entities.Dtdl.Content value1)
            {
            ...
            /// <returns>A ContentArray instantiated from the given items.</returns>
            public static ContentArray FromItems(in BuildingOS.Shared.Entities.Dtdl.Content value1, in BuildingOS.Shared.Entities.Dtdl.Content value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A ContentArray instantiated from the given items.</returns>
            public static ContentArray FromItems(in BuildingOS.Shared.Entities.Dtdl.Content value1, in BuildingOS.Shared.Entities.Dtdl.Content value2, in BuildingOS.Shared.Entities.Dtdl.Content value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static ContentArray FromItems(params BuildingOS.Shared.Entities.Dtdl.Content[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.Content item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static ContentArray FromRange(IEnumerable<BuildingOS.Shared.Entities.Dtdl.Content> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.Content item in value)
                {
            ...
            /// </remarks>
            public static ContentArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new ContentArray(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static ContentArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static ContentArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.Content> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.Content>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.Content>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<ContentArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<ContentArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
