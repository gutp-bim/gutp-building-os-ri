...
public readonly partial struct ValidMessage
{
    ...
    /// </para>
    /// </remarks>
    public readonly partial struct ValidTelemetryEntity : IJsonObject<ValidTelemetryEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "ValidTelemetryEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ValidTelemetryEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator ValidTelemetryEntity(JsonObject value)
        {
        ...
        public static ValidTelemetryEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ValidTelemetryEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static ValidTelemetryEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public ValidTelemetryEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public ValidTelemetryEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ValidTelemetryEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ValidTelemetryEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public ValidTelemetryEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
