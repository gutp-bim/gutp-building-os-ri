...
public readonly partial struct EnvironmentalDeviceMessageJson
{
    ...
    /// </summary>
    public readonly partial struct EnvironmentalDeviceTelemetryEntity : IJsonObject<EnvironmentalDeviceTelemetryEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "EnvironmentalDeviceTelemetryEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EnvironmentalDeviceTelemetryEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator EnvironmentalDeviceTelemetryEntity(JsonObject value)
        {
        ...
        public static EnvironmentalDeviceTelemetryEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static EnvironmentalDeviceTelemetryEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static EnvironmentalDeviceTelemetryEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public EnvironmentalDeviceTelemetryEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public EnvironmentalDeviceTelemetryEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public EnvironmentalDeviceTelemetryEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public EnvironmentalDeviceTelemetryEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public EnvironmentalDeviceTelemetryEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
