...
public readonly partial struct HvacDeviceMessageJson
{
    ...
    /// </summary>
    public readonly partial struct HvacDeviceTelemetryEntity : IJsonObject<HvacDeviceTelemetryEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "HvacDeviceTelemetryEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public HvacDeviceTelemetryEntity(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator HvacDeviceTelemetryEntity(JsonObject value)
        {
        ...
        public static HvacDeviceTelemetryEntity FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static HvacDeviceTelemetryEntity FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static HvacDeviceTelemetryEntity FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public HvacDeviceTelemetryEntity SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public HvacDeviceTelemetryEntity RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public HvacDeviceTelemetryEntity RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public HvacDeviceTelemetryEntity RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public HvacDeviceTelemetryEntity RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
