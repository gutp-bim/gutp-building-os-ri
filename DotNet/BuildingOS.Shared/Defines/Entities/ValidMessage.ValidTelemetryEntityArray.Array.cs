...
public readonly partial struct ValidMessage
{
    ...
    public readonly partial struct ValidTelemetryEntityArray : IJsonArray<ValidTelemetryEntityArray>
    {
        ...
        public BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static ValidTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity value1)
        {
        ...
        /// <returns>A ValidTelemetryEntityArray instantiated from the given items.</returns>
        public static ValidTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity value1, in BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ValidTelemetryEntityArray instantiated from the given items.</returns>
        public static ValidTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity value1, in BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity value2, in BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ValidTelemetryEntityArray FromItems(params BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ValidTelemetryEntityArray FromRange(IEnumerable<BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.ValidMessage.ValidTelemetryEntity>(this.arrayBacking);
            }
