                ...
                public readonly partial struct PropertiesEntity
                {
                    ...
                    public readonly partial struct PresentValueEntity
                    {
                        private ValidationContext ValidateOneOf(in ValidationContext validationContext, ValidationLevel level)
                        {
                            ...
                            ValidationContext oneOfResult0 = this.As<Corvus.Json.JsonNumber>().Validate(childContext0.CreateChildContext(), level);
                            ...
                            ValidationContext oneOfResult1 = this.As<Corvus.Json.JsonInteger>().Validate(childContext1.CreateChildContext(), level);
