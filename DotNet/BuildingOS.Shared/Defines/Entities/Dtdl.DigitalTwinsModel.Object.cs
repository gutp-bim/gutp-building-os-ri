...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct DigitalTwinsModel : IJsonObject<DigitalTwinsModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DigitalTwinsModel"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DigitalTwinsModel(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator DigitalTwinsModel(JsonObject value)
        {
        ...
        public static DigitalTwinsModel FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwinsModel FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwinsModel FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DigitalTwinsModel SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public DigitalTwinsModel RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsModel RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsModel RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsModel RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
