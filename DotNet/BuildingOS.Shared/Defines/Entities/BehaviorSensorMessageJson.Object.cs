...
/// </summary>
public readonly partial struct BehaviorSensorMessageJson : IJsonObject<BehaviorSensorMessageJson>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "BehaviorSensorMessageJson"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public BehaviorSensorMessageJson(ImmutableList<JsonObjectProperty> value)
    {
    ...
    public static implicit operator BehaviorSensorMessageJson(JsonObject value)
    {
    ...
    public static BehaviorSensorMessageJson FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static BehaviorSensorMessageJson FromProperties(ImmutableList<JsonObjectProperty> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static BehaviorSensorMessageJson FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public BehaviorSensorMessageJson SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public BehaviorSensorMessageJson RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public BehaviorSensorMessageJson RemoveProperty(string name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public BehaviorSensorMessageJson RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetPropertyBackingWithout(name));
    }

    /// <inheritdoc/>
    public BehaviorSensorMessageJson RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
