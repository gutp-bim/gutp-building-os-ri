...
public readonly partial struct BacnetDeviceMessageJson
{
    public readonly partial struct ItemsEntity
    {
        ...
        /// </summary>
        public readonly partial struct ValueStringEntityArray : IJsonArray<ValueStringEntityArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly ValueStringEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "ValueStringEntityArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ValueStringEntityArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public ValueStringEntityArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<ValueStringEntityArray>.this[int index]
            {
                get
                {
            ...
            public BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(ValueStringEntityArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator ValueStringEntityArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator ValueStringEntityArray(JsonArray value)
            {
            ...
            public static ValueStringEntityArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            /// <returns>A ValueStringEntityArray instantiated from the given items.</returns>
            public static ValueStringEntityArray FromItems(in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity value1)
            {
            ...
            /// <returns>A ValueStringEntityArray instantiated from the given items.</returns>
            public static ValueStringEntityArray FromItems(in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity value1, in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A ValueStringEntityArray instantiated from the given items.</returns>
            public static ValueStringEntityArray FromItems(in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity value1, in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity value2, in BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static ValueStringEntityArray FromItems(params BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static ValueStringEntityArray FromRange(IEnumerable<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity item in value)
                {
            ...
            /// </remarks>
            public static ValueStringEntityArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new ValueStringEntityArray(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static ValueStringEntityArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static ValueStringEntityArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.BacnetDeviceMessageJson.ItemsEntity.ValueStringEntityArray.ValueStringEntity>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<ValueStringEntityArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<ValueStringEntityArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
