...
public readonly partial struct Dtdl
{
    public readonly partial struct PurpleSchema
    {
        ...
        /// </summary>
        public readonly partial struct FluffyFieldArray : IJsonArray<FluffyFieldArray>
        {
            /// <summary>
            /// Gets an empty array.
            /// </summary>
            public static readonly FluffyFieldArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
            /// <summary>
            /// Initializes a new instance of the <see cref = "FluffyFieldArray"/> struct.
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public FluffyFieldArray(ImmutableList<JsonAny> value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to construct the instance.</param>
            public FluffyFieldArray(IEnumerable<JsonAny> value)
            {
                this.jsonElementBacking = default;
                this.backing = Backing.Array;
            ...
            /// <inheritdoc/>
            JsonAny IJsonArray<FluffyFieldArray>.this[int index]
            {
                get
                {
            ...
            public BuildingOS.Shared.Entities.Dtdl.FluffyField this[int index]
            {
                get
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new BuildingOS.Shared.Entities.Dtdl.FluffyField(this.jsonElementBacking[index]);
                    }
                    ...
                    if ((this.backing & Backing.Array) != 0)
                    {
                        try
                        {
                            return this.arrayBacking[index].As<BuildingOS.Shared.Entities.Dtdl.FluffyField>();
                        }
                        catch (ArgumentOutOfRangeException ex)
                        {
                            throw new IndexOutOfRangeException(ex.Message, ex);
            ...
            public static implicit operator ImmutableList<JsonAny>(FluffyFieldArray value)
            {
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator FluffyFieldArray(ImmutableList<JsonAny> value)
            {
                return new(value);
            }
            ...
            /// </summary>
            /// <param name = "value">The value from which to convert.</param>
            public static implicit operator FluffyFieldArray(JsonArray value)
            {
            ...
            public static FluffyFieldArray From(ImmutableList<JsonAny> items)
            {
                return new(items);
            }
            ...
            /// <returns>A FluffyFieldArray instantiated from the given items.</returns>
            public static FluffyFieldArray FromItems(in BuildingOS.Shared.Entities.Dtdl.FluffyField value1)
            {
            ...
            /// <returns>A FluffyFieldArray instantiated from the given items.</returns>
            public static FluffyFieldArray FromItems(in BuildingOS.Shared.Entities.Dtdl.FluffyField value1, in BuildingOS.Shared.Entities.Dtdl.FluffyField value2)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
            ...
            /// <returns>A FluffyFieldArray instantiated from the given items.</returns>
            public static FluffyFieldArray FromItems(in BuildingOS.Shared.Entities.Dtdl.FluffyField value1, in BuildingOS.Shared.Entities.Dtdl.FluffyField value2, in BuildingOS.Shared.Entities.Dtdl.FluffyField value3)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                builder.Add(value1.AsAny);
                builder.Add(value2.AsAny);
            ...
            public static FluffyFieldArray FromItems(params BuildingOS.Shared.Entities.Dtdl.FluffyField[] value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.FluffyField item in value)
                {
            ...
            /// <param name = "value">The value from which to construct the instance.</param>
            /// <returns>A JsonAny instantiated from the given items.</returns>
            public static FluffyFieldArray FromRange(IEnumerable<BuildingOS.Shared.Entities.Dtdl.FluffyField> value)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                foreach (BuildingOS.Shared.Entities.Dtdl.FluffyField item in value)
                {
            ...
            /// </remarks>
            public static FluffyFieldArray From<T>(IEnumerable<T> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
                ...
                return new FluffyFieldArray(builder.ToImmutable());
            }
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static FluffyFieldArray FromRange(IEnumerable<JsonAny> items)
            {
                ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            /// other overloads which avoid this serialization step.
            /// </remarks>
            public static FluffyFieldArray FromRange<T>(IEnumerable<T> items)
            ...
            /// <inheritdoc/>
            public JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.FluffyField> EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.FluffyField>(this.jsonElementBacking);
                }

                if ((this.backing & Backing.Array) != 0)
                {
                    return new JsonArrayEnumerator<BuildingOS.Shared.Entities.Dtdl.FluffyField>(this.arrayBacking);
                }
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator IJsonArray<FluffyFieldArray>.EnumerateArray()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
            ...
            /// <inheritdoc/>
            JsonArrayEnumerator<TItem> IJsonArray<FluffyFieldArray>.EnumerateArray<TItem>()
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
