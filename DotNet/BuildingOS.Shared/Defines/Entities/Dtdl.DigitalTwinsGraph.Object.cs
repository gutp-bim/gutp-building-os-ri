...
public readonly partial struct Dtdl
{
    ...
    /// </summary>
    public readonly partial struct DigitalTwinsGraph : IJsonObject<DigitalTwinsGraph>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "DigitalTwinsGraph"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DigitalTwinsGraph(ImmutableList<JsonObjectProperty> value)
        {
        ...
        public static implicit operator DigitalTwinsGraph(JsonObject value)
        {
        ...
        public static DigitalTwinsGraph FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
        {
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwinsGraph FromProperties(ImmutableList<JsonObjectProperty> source)
        {
            return new(source);
        }
        ...
        /// <param name = "source">The dictionary of properties.</param>
        /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
        public static DigitalTwinsGraph FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
        {
        ...
        /// <inheritdoc/>
        public DigitalTwinsGraph SetProperty<TValue>(in JsonPropertyName name, TValue value)
        ...
        /// <inheritdoc/>
        public DigitalTwinsGraph RemoveProperty(in JsonPropertyName name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsGraph RemoveProperty(string name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsGraph RemoveProperty(ReadOnlySpan<char> name)
        {
            return new(this.GetPropertyBackingWithout(name));
        }

        /// <inheritdoc/>
        public DigitalTwinsGraph RemoveProperty(ReadOnlySpan<byte> utf8Name)
        {
