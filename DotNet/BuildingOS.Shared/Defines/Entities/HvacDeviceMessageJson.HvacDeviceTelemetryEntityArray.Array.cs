...
public readonly partial struct HvacDeviceMessageJson
{
    ...
    /// </summary>
    public readonly partial struct HvacDeviceTelemetryEntityArray : IJsonArray<HvacDeviceTelemetryEntityArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly HvacDeviceTelemetryEntityArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "HvacDeviceTelemetryEntityArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public HvacDeviceTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public HvacDeviceTelemetryEntityArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <inheritdoc/>
        JsonAny IJsonArray<HvacDeviceTelemetryEntityArray>.this[int index]
        {
            get
            {
        ...
        public BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                {
                    return new BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity(this.jsonElementBacking[index]);
                }
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator ImmutableList<JsonAny>(HvacDeviceTelemetryEntityArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator HvacDeviceTelemetryEntityArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator HvacDeviceTelemetryEntityArray(JsonArray value)
        {
        ...
        public static HvacDeviceTelemetryEntityArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A HvacDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static HvacDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity value1)
        {
        ...
        /// <returns>A HvacDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static HvacDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity value1, in BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A HvacDeviceTelemetryEntityArray instantiated from the given items.</returns>
        public static HvacDeviceTelemetryEntityArray FromItems(in BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity value1, in BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity value2, in BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static HvacDeviceTelemetryEntityArray FromItems(params BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static HvacDeviceTelemetryEntityArray FromRange(IEnumerable<BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity item in value)
            {
        ...
        /// </remarks>
        public static HvacDeviceTelemetryEntityArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new HvacDeviceTelemetryEntityArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static HvacDeviceTelemetryEntityArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static HvacDeviceTelemetryEntityArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<BuildingOS.Shared.Entities.HvacDeviceMessageJson.HvacDeviceTelemetryEntity>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<HvacDeviceTelemetryEntityArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<HvacDeviceTelemetryEntityArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
